...
def home_content():
    ...
    <style>
        ...
        * {{ font-family: 'Inter', sans-serif !important; }}
        ...
        .hpill {{ display:inline-flex;align-items:center;gap:7px;
            background:rgba(255,255,255,0.06);border:1px solid rgba(255,255,255,0.13);
            border-radius:99px;padding:8px 17px;font-size:12.5px;font-weight:600;
            color:rgba(255,255,255,0.72);transition:all .2s ease; }}
        .hpill:hover {{ background:rgba(255,255,255,0.12);transform:translateY(-2px); }}
        ...
        .mod-topbar {{ position:absolute;top:0;left:0;right:0;height:4px;
