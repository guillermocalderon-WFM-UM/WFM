...
<style>
    ...
    * {{ font-family: 'Inter', sans-serif !important; }}
    ...
    .ocu-soon-desc  {{ font-size:13px;color:rgba(255,255,255,0.85);margin:0;line-height:1.6;position:relative;z-index:1; }}
    .ocu-soon-tag {{ margin-left:auto;flex-shrink:0;position:relative;z-index:1;
        background:rgba(255,255,255,0.95);color:#B45309;font-size:11px;font-weight:800;
...
<div class='ocu-features'>
    <div class='ocu-feat' style='--fc:#F59E0B;--fcbg:linear-gradient(135deg,rgba(245,158,11,0.18),rgba(245,158,11,0.05))'>
        <div class='ocu-feat-ico'>📣</div>
        <div class='ocu-feat-title'>Anuncios</div>
        <div class='ocu-feat-desc'>Comunicados y avisos importantes del equipo Workforce Management en tiempo real.</div>
    </div>
    <div class='ocu-feat' style='--fc:#0EA5E9;--fcbg:linear-gradient(135deg,rgba(14,165,233,0.18),rgba(14,165,233,0.05))'>
        <div class='ocu-feat-ico'>📝</div>
        <div class='ocu-feat-title'>Registro de Cambios</div>
        <div class='ocu-feat-desc'>Historial de mejoras y nuevas funciones agregadas al tablero por versión.</div>
    </div>
    <div class='ocu-feat' style='--fc:#8B5CF6;--fcbg:linear-gradient(135deg,rgba(139,92,246,0.18),rgba(139,92,246,0.05))'>
        <div class='ocu-feat-ico'>🔔</div>
        <div class='ocu-feat-title'>Alertas y Recordatorios</div>
        <div class='ocu-feat-desc'>Notificaciones de eventos relevantes y recordatorios para el equipo.</div>
    </div>
</div>
""", unsafe_allow_html=True)
...
<div class='ocu-soon'>
    ...
    <div>
        ...
        <div class='ocu-soon-desc'>
            ...
            Cuando esté listo, aquí verás los comunicados y el registro de cambios del tablero.
        </div>
    </div>
